...
def test_calculator_generic():
    mol_out = generic.run_op(molecule("CH4"), LennardJones(), properties=["energy", "forces"],
...
def test_name_auto():
    ...
    mol_out = generic.run_op(molecule("CH4"), LennardJones(), properties=["energy", "forces"], output_prefix="_auto_")
...
def test_atoms_list():
    ...
    mol_out = generic.run_op(mol_in, LennardJones(), properties=["energy", "forces"],
...
def test_default_properties():
    mol_out = generic.run_op(bulk("C"), EMT(), output_prefix="dummy_")
